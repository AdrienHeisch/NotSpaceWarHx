...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		lime.system.System.__registerEntryPoint ("NotSpaceWar", create);
		
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed ("NotSpaceWar", null, 1280, 720);
		#end
		#else
		create (null);
		#end
		...
		var config = {
			...
			name: "NotSpaceWar",
			orientation: "",
			packageName: "com.adrienheisch.spacewar",
			version: "1.0.0",
			windows: [
	...
	public static function create (config):Void {
		...
		app.meta["packageName"] = "com.adrienheisch.spacewar";
	...
	macro public static function getEntryPoint () {
		...
		switch (Context.follow (Context.getType ("com.adrienheisch.spacewar.Main"))) {
			...
			case TInst (t, params):
				...
				if (hasMain) {
					...
					return Context.parse ("@:privateAccess com.adrienheisch.spacewar.Main.main ()", Context.currentPos ());
					...
					Context.fatalError ("Main class \"com.adrienheisch.spacewar.Main\" has neither a static main nor a constructor.", Context.currentPos ());
					
				}
				
			default:
				
				Context.fatalError ("Main class \"com.adrienheisch.spacewar.Main\" isn't a class.", Context.currentPos ());
...
@:keep @:dox(hide) class DocumentClass extends com.adrienheisch.spacewar.Main {}
