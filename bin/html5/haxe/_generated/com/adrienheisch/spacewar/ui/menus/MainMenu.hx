package com.adrienheisch.spacewar.ui.menus; #if !flash
...
#else
@:bind @:native("com.adrienheisch.spacewar.ui.menus.MainMenu") class MainMenu extends flash.display.MovieClip {
