...
class ChooseNPlayersScreen extends MovieClip {
	
	
	public var mcButton1 (default, null):NumberButton;
...
#else
@:bind @:native("ChooseNPlayersScreen") class ChooseNPlayersScreen extends flash.display.MovieClip {
